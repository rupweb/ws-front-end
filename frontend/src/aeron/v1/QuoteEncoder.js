...
class QuoteEncoder {
    ...
    encodefxRate(value) {
        this.fxRateEncoder.wrap(this.buffer.buffer, this.offset + 83);
        this.fxRateEncoder.mantissa(value.mantissa);
        this.fxRateEncoder.exponent(value.exponent);
    }

    encodesecondaryAmount(value) {
        this.secondaryAmountEncoder.wrap(this.buffer.buffer, this.offset + 92);
    ...
    // Encode clientID
    clientID(value) {
        this.putString(this.offset + 101, value, 4);
        return this;
    }
