...
class PostTradeCreditNoticeEncoder {
    ...
    wrapAndApplyHeader(buffer, offset, headerEncoder) {
        headerEncoder.wrap(buffer, offset)
            .blockLength(PostTradeCreditNoticeEncoder.BLOCK_LENGTH)
            .templateId(PostTradeCreditNoticeEncoder.TEMPLATE_ID)
            .schemaId(PostTradeCreditNoticeEncoder.SCHEMA_ID)
            .version(PostTradeCreditNoticeEncoder.SCHEMA_VERSION);
...
export default PostTradeCreditNoticeEncoder;
