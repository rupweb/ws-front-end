...
class DebitNoticeEncoder {
    ...
    wrapAndApplyHeader(buffer, offset, headerEncoder) {
        headerEncoder.wrap(buffer, offset)
            .blockLength(DebitNoticeEncoder.BLOCK_LENGTH)
            .templateId(DebitNoticeEncoder.TEMPLATE_ID)
            .schemaId(DebitNoticeEncoder.SCHEMA_ID)
            .version(DebitNoticeEncoder.SCHEMA_VERSION);
...
export default DebitNoticeEncoder;
