...
class ClientPersistenceTest {
    ...
    void testPersistClientOnboarding() throws Exception {
        ...
        Client client = new Client(
            "fullName", "dateOfBirth", "nationality", "governmentID",
        ...
        // Act
        PersistenceQueue.getInstance().getQueue().put(dealRequest);
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:sqlite:client.db");
             ...
             ResultSet rs = stmt.executeQuery("SELECT * FROM Client WHERE clientID = 'DR123'")) {
